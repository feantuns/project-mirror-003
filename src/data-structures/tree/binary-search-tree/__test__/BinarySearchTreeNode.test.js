...
describe("BinarySearchTreeNode", () => {
  ...
  it("should insert in itself it is empty", () => {
  ...
  it("should remove nodes with tow children", () => {
    const bstRootNode = new BinarySearchTreeNode();
  ...
  it("should be possible to use objects as node values", () => {
    const nodeValueComparatorCallback = (a, b) => {
      ...
      const normailzedB = b || { value: null };

      if (normalizedA.value === normailzedB.value) {
        return 0;
      }

      return normalizedA.value < normailzedB.value ? -1 : 1;
    };
