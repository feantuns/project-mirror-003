...
describe("BloomFilter", () => {
  ...
  it("should hash deterministically with all 3 hash functions", () => {
    ...
    expect(bloomFilter.hash1(strl)).toEqual(bloomFilter.hash1(strl));
    expect(bloomFilter.hash2(strl)).toEqual(bloomFilter.hash2(strl));
    expect(bloomFilter.hash3(strl)).toEqual(bloomFilter.hash3(strl));

    expect(bloomFilter.hash1(strl)).toBe(14);
    expect(bloomFilter.hash2(strl)).toBe(43);
    expect(bloomFilter.hash3(strl)).toBe(10);
