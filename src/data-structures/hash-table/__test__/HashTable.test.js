...
describe("HashTable", () => {
  ...
  it("should set, read and delete data with collisions", () => {
    ...
    const stringfier = (value) => `${value.key}:${value.value}`;

    expect(hashTable.buckets[0].toString(stringfier)).toBe("c:earth");
    expect(hashTable.buckets[1].toString(stringfier)).toBe("a:sky,d:ocean");
    expect(hashTable.buckets[2].toString(stringfier)).toBe("b:sea");
