...
export default class SimplePolynomialHash {
   ...
   *
   * Time complexity: 0(word.length).
   *
   * @assumption: This version of the function doesn't use modulo operator. Thus it may produce number overfloes by generating numbers that are bigger than Number.MAX_SAFE_INTEGER. This function is mentioned here for siplcity and LEARNING reasons.
   *
   ...
   *
   * Recalculates the hash representation of a word so that it isn't necessary to traverse the whole word again.
   *
   * Time complexity: 0(1);
   *
